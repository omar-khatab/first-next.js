...
export default async function PostDetailsPage ({params}) {
    ...
    <div style={{padding: "20px"}}>
        <h1>Post Details</h1>
        {/* suspense tag to show data direct when its take is taken and this is useful in case of page have many requests
        ...
        make use to make customize loading for a part of page inverse the loading.js that makes customize loading for whole page */}
