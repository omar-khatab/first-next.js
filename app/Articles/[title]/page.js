...
// param is the one of the parameter of the function that is considered the path of link the replace of the dynamic routing name
...
export default function showDynamicRounting (props) {
    ...
    return (
        <div>
            ...
            {/* this will access on the path parameter of title */}
